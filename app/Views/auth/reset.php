                    ...
                    <div class="bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border flex flex-col w-full max-w-full px-3 mx-auto lg:mx-0 shrink-0 md:flex-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                        <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none lg:py4 dark:bg-gray-950 rounded-2xl bg-clip-border">
                            ...
                            <div class="flex-auto p-6">
                                <form role="form" id="form-reset-password" method="POST" action="<?= base_url('auth/reset') ?>" show-validation>
                                    <input type="hidden" value="<?= $reset_key; ?>" name="key">
                                    <div>
...
<script>
    initFormAjax('#form-reset-password', {
        beforeSend: function() {
